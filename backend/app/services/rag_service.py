...
class RagService:
    ...
    def answer(self, user_query: str, memory_context: str = "") -> dict[str, Any]:
        concepts = self.concept_resolver.resolve(user_query)
        concept_context = self.concept_resolver.build_context(concepts)
        ...
        result = answer_question(question=user_query,memory_context=memory_context,retrieval_query=rewritten_query,concept_context=concept_context,concepts=concepts)
